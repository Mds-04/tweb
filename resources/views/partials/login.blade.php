<div id="modal-login" class="modal-overlay">
    <div class="modal-content">
        ...
        <img src="{{ asset('img/noBgLogo.png') }}" alt="EventTicket Logo"
            style="width: 80px; margin: 0 auto 15px; display: block;">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <p class="testo-registrati">Non hai un account? <a href="#" id="link-apri-register"
                    class="register">Registrati</a></p>
        </form>
    </div>
</div>
