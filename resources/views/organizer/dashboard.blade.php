...
<body class="dashboard-body">
        ...
        <main class="dashboard-main">
            ...
            <section id="analisi" class="dashboard-section active">
                ...
                <div class="search-bar-container" style="position: relative; margin-bottom: 20px;">
                    <input type="text" id="search-analisi" class="search-input" placeholder="Cerca evento..." onkeydown="if(event.key === 'Enter') filterTable('search-analisi', 'table-analisi')" style="width: 100%; padding: 10px 40px 10px 10px; border-radius: 5px; border: 1px solid #ccc; font-family: inherit;">
            ...
            <section id="biglietti" class="dashboard-section" style="display: none;">
                ...
                <div class="search-bar-container" style="position: relative; margin-bottom: 20px;">
                    <input type="text" id="search-biglietti" class="search-input" placeholder="Cerca evento..." onkeydown="if(event.key === 'Enter') filterCards('search-biglietti', 'grid-biglietti')" style="width: 100%; padding: 10px 40px 10px 10px; border-radius: 5px; border: 1px solid #ccc; font-family: inherit;">
                    <i class="fa-solid fa-magnifying-glass" onclick="filterCards('search-biglietti', 'grid-biglietti')" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #666;"></i>
                </div>
            ...
            <section id="sconti" class="dashboard-section" style="display: none;">
                ...
                <div class="search-bar-container" style="position: relative; margin-bottom: 20px;">
                    <input type="text" id="search-sconti" class="search-input" placeholder="Cerca evento..." onkeydown="if(event.key === 'Enter') filterCards('search-sconti', 'grid-sconti')" style="width: 100%; padding: 10px 40px 10px 10px; border-radius: 5px; border: 1px solid #ccc; font-family: inherit;">
                    <i class="fa-solid fa-magnifying-glass" onclick="filterCards('search-sconti', 'grid-sconti')" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #666;"></i>
                </div>
            ...
            <section id="eventi" class="dashboard-section" style="display: none;">
                ...
                <div class="search-bar-container" style="position: relative; margin-bottom: 20px;">
                    <input type="text" id="search-eventi" class="search-input" placeholder="Cerca evento..." onkeydown="if(event.key === 'Enter') filterTable('search-eventi', 'table-eventi')" style="width: 100%; padding: 10px 40px 10px 10px; border-radius: 5px; border: 1px solid #ccc; font-family: inherit;">
                    <i class="fa-solid fa-magnifying-glass" onclick="filterTable('search-eventi', 'table-eventi')" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #666;"></i>
                </div>
                            ...
                            @foreach($eventi as $evento)
                                <tr>
                                    ...
                                    <td class="actions-cell">
                                        ...
                                        <button type="button" class="btn-icon delete" onclick="openDeleteModal('{{ route('organizer.events.destroy', $evento->id) }}')"><i class="fa-solid fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div id="eventModal" class="modal-overlay">
        <div class="modal-content large-modal" style="padding: 0; border-radius: 12px; overflow: hidden; background: #fff;">
            <div style="max-height: 90vh; overflow-y: auto; padding: 30px; position: relative;">
                ...
                <form id="eventForm" action="{{ route('organizer.events.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <select name="categoria" id="evt_categoria" required style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ccc; font-family: inherit;">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary" id="submitEventBtn" style="margin-top: 15px;">Salva Evento</button>
                </div>
            </form>
            </div>
        </div>
    ...
    <div id="deleteModal" class="modal-overlay">
        <div class="modal-content" style="max-width: 400px; text-align: center; padding: 40px 30px;">
            ...
            <p style="margin-bottom: 30px; color: #666; font-size: 15px;">Vuoi davvero eliminare questo evento in modo permanente?</p>
