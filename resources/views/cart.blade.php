    ...
    <div class="cart-container">
        ...
        @if ($errors->has('cart'))
            <div class="alert alert-danger"
                style="background-color: #f8d7da; color: #721c24; padding: 15px; border-radius: 10px; margin-bottom: 20px; text-align: center;">
                {{ $errors->first('cart') }}
            </div>
        @endif
                        ...
                        <tr>
                            <td>
                                ...
                                @if (isset($details['sconto_applicato']) && $details['sconto_applicato'])
                                    <div class="item-meta" style="color: var(--primary-color);">Sconto Last-Minute
                                        Applicato! (Prezzo orig: €
                                        {{ number_format($details['original_price'], 2, ',', '.') }})</div>
                                @endif
                            </td>
                            ...
                            <td><strong>€
                                    {{ number_format($details['price'] * $details['quantity'], 2, ',', '.') }}</strong>
                            </td>
            ...
            <form action="{{ route('cart.checkout') }}" method="POST">
                ...
                <div class="cart-summary">
                    ...
                    <div class="summary-totals">
                        ...
                        <button type="submit" class="btn-checkout">Procedi all'Acquisto <i
                                class="fa-solid fa-arrow-right" style="margin-left: 10px;"></i></button>
                    </div>
                </div>
            </form>
        @else
            <div class="empty-cart">
                ...
                <a href="{{ url('/') }}" class="btn loginBtn" style="padding: 10px 25px;">Scopri i nostri
                    eventi</a>
            </div>
        @endif
    </div>
